...
public final class ImeBridgeHook implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        if (BridgeContract.PACKAGE_OPEN_SOURCE.equals(lpparam.packageName) ||
            ...
            // 原来是 "com.brycewg.asrkb.imebridge"——合并进 GboardHooker 后模块自己
            // 真实的包名变成了 io.github.a110789.gboardhooker，这里也要跟着换，
            // 不然这个自我保护判断形同虚设（永远不会命中）。
            "io.github.a110789.gboardhooker".equals(lpparam.packageName)) {
            return;
        }
